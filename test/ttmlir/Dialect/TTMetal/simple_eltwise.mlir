// RUN: ttmlir-opt --ttir-load-system-desc --ttir-implicit-device --ttir-generic-eltwise --ttir-layout --ttir-generic-region-operands-to-memref --ttir-allocate --convert-ttir-to-ttmetal %s | FileCheck %s
